...
ifeq ($(call is-board-platform-in-list,$(TRINKET) atoll),true)
AUDIO_SELECT  := CONFIG_SND_SOC_SM6150=m
endif

AUDIO_CHIPSET := audio
# Build/Package only in case of supported target
ifeq ($(call is-board-platform-in-list,msm8953 msm8937 sdm845 sdm670 qcs605 sdmshrike msmnile atoll $(MSMSTEPPE) $(TRINKET)),true)
...
include $(DLKM_DIR)/AndroidKernelModule.mk
###########################################################
ifeq ($(call is-board-platform-in-list,msm8937 sdm670 qcs605 $(TRINKET)),true)
include $(CLEAR_VARS)
...
###########################################################
ifeq ($(call is-board-platform-in-list, msm8937 sdm710 qcs605),true)
include $(CLEAR_VARS)
